...
function CreateCurveLink(m, d, y, name)
  ...
  if GetLocale == "enUS" then
    DEFAULT_CHAT_FRAME:AddMessage("\124cffffff00\124Hachievement:12110:"
    ..string.gsub(UnitGUID("player"), '0x', '')..":1:".. m ..":".. d ..":".. y ..":4294967295:4294967295:4294967295:4294967295\124h[".. Name .."]\124h\124r")
  else DEFAULT_CHAT_FRAME:AddMessage("\124cffffff00\124Hachievement:12110:"
...
function CreateKeyMasterLink(m, d, y, name)
  ...
  if GetLocale == "enUS" then
    DEFAULT_CHAT_FRAME:AddMessage("\124cffffff00\124Hachievement:11162:"
    ..string.gsub(UnitGUID("player"), '0x', '')..":1:".. m ..":".. d ..":".. y ..":4294967295:4294967295:4294967295:4294967295\124h[".. Name .."]\124h\124r")
  else DEFAULT_CHAT_FRAME:AddMessage("\124cffffff00\124Hachievement:11162:"
    ..string.gsub(UnitGUID("player"), '0x', '')..":1:".. d ..":".. m ..":".. y ..":4294967295:4294967295:4294967295:4294967295\124h[".. Name .."]\124h\124r")
  end
end
...
local function handler3(msg, editbox)
  ...
  IDNumber, Name = GetAchievementInfo(achievement) -- Get Name so we dont have to localize by hand
    ...
    DEFAULT_CHAT_FRAME:AddMessage("\124cffffff00\124Hachievement:".. achievement ..":"
