...
if msg == 'help' then
 ...
 elseif msg == '' then
  ...
  DEFAULT_CHAT_FRAME:AddMessage("\124cffffff00\124Hachievement:12110:"..string.gsub(UnitGUID("player"), '0x', '')..":1:".. month ..":".. day ..":".. year-2000 ..":4294967295:4294967295:4294967295:4294967295\124h[Ahead of the Curve: Argus the Unmaker]\124h\124r")
  else
  local m, d, y = strsplit(",",msg)
  if string.len(y) > 2 then y=y-2000 end
  DEFAULT_CHAT_FRAME:AddMessage("\124cffffff00\124Hachievement:12110:"..string.gsub(UnitGUID("player"), '0x', '')..":1:".. m ..":".. d ..":".. y ..":4294967295:4294967295:4294967295:4294967295\124h[Ahead of the Curve: Argus the Unmaker]\124h\124r")
 end
end
